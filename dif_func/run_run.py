...
# print(int(Str4_1_1('^GSPC', share_tick1c, stime='2020-05-01', ftime='2021-10-01', interval='1wk').sum_results()))
# print(Str4_1_1('^GSPC', share_tick1cc, stime='2020-05-01', ftime='2021-10-01', interval='1wk').get_counts())
# print(int(Str4_1_1('^GSPC', share_tick1d, stime='2021-06-01', ftime='2022-04-03', interval='1wk').sum_results()))
# print(Str4_1_1('^GSPC', share_tick1dd, stime='2021-06-01', ftime='2022-04-03', interval='1wk').get_counts())
# print(int(Str4_1_1('^GSPC', share_tick1e, stime='2022-01-01', interval='1wk').sum_results()))
# print(Str4_1_1('^GSPC', share_tick1ee, stime='2022-01-01', interval='1wk').get_counts())
...
print(int(Str4_2_2('^GSPC', share_tick1c, stime='2020-05-01', ftime='2021-10-01', interval='1wk').sum_results()))
print(Str4_2_2('^GSPC', share_tick1cc, stime='2020-05-01', ftime='2021-10-01', interval='1wk').get_counts())
print(int(Str4_2_2('^GSPC', share_tick1d, stime='2021-06-01', ftime='2022-04-03', interval='1wk').sum_results()))
print(Str4_2_2('^GSPC', share_tick1dd, stime='2021-06-01', ftime='2022-04-03', interval='1wk').get_counts())
print(int(Str4_2_2('^GSPC', share_tick1e, stime='2022-01-01', interval='1wk').sum_results()))
print(Str4_2_2('^GSPC', share_tick1ee, stime='2022-01-01', interval='1wk').get_counts())
