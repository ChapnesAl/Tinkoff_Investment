...
"""  4 1 1 """
print(Str4_1_1('^GSPC', share_tick1, stime='2020-01-01', ftime='2021-01-01', interval='1wk').sum_results())

print(Str4_1_1('^GSPC', share_tick1, stime='2021-01-01', ftime='2022-01-01', interval='1wk').sum_results())

print(Str4_1_1('^GSPC', share_tick1, stime='2022-01-01', ftime='2022-08-03', interval='1wk').sum_results())